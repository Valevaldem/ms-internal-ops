...
import { updateAsesoraAction } from "./actions";
...
type AsesoraData = {
  ...
  appliesMsAdjustment: boolean;
};

export default function EditarAsesoraClient({
  asesora,
}: {
  asesora: AsesoraData;
}) {
  const [state, formAction, isPending] = useActionState(async (prevState: any, formData: FormData) => {
    return updateAsesoraAction(asesora.id, formData);
  }, { error: "" });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="mt-2 flex items-center">
                <input
                  ...
                  name="activeStatus"
                  type="checkbox"
                  defaultChecked={asesora.activeStatus}
            ...
            <div className="md:col-span-2 pt-4 border-t border-[#EAE5DF]">
              ...
              <p className="text-xs text-[#8E8D8A] mb-3">
                Si esta asesora aplica el ajuste comercial "MS" en las cotizaciones.
              </p>
              <div className="flex items-center">
                <input
                  ...
                  type="checkbox"
                  defaultChecked={asesora.appliesMsAdjustment}
                  className="h-4 w-4 text-[#C5B358] focus:ring-[#C5B358] border-gray-300 rounded"
                />
